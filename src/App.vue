<template>
  <div id="app">
    <div id="nav" class="w-full max-w-lg mx-auto mt-4 flex items-center">
      <router-link
        to="/"
        class="shadow bg-white py-4 px-4 flex-1 text-center font-semibold"
        >Income Tax</router-link
      >
      <router-link
        to="/vat-calculator"
        class=" bg-gray-100 py-4 px-4 flex-1 text-center font-semibold"
        >VAT</router-link
      >
    </div>
    <router-view />
    <footer
      id="footer"
      class="w-full max-w-2xl mx-auto mt-6 text-gray-600 text-xs "
      v-cloak
    >
      <div class="text-center uppercase" style="margin-top: 0;">
        Disclaimer: We do our best to ensure the accuracy of this tool but we
      ...
      <div class="text-center">
        ...
        <a
          ...
          href="mailto:tax.calculator@kessir.com?subject=Tax%20calculator"
